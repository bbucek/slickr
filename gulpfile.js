...
var Paths = {
  HERE                 : './',
  SCSS_TOOLKIT_SOURCES : 'vendor/bootstrap_theme/scss/toolkit*',
  ...
  JS_TOOLKIT_SOURCES   : 'app/assets/javascripts/admin/theme/toolkit.js',
  DIST                 : 'app/assets/stylesheets/admin/theme',
  DIST_TOOLKIT_JS      : 'app/assets/javascripts/admin/theme'
}
...
gulp.task('production', function(callback){
  runSequence('delete-all-css', 'delete-all-js', 'scss-min', 'js-min', callback);
});

gulp.task('delete-css', function(){
  return gulp.src("./app/assets/stylesheets/active_admin/*.css", { read: false }) // much faster
...
gulp.task('delete-all-js', function () {
  return del([
    Paths.DIST_TOOLKIT_JS + '/**',
  ]);
});
